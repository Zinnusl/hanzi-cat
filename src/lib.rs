...
// Expanded curated set of Hanzi and multi-character words with pinyin + tone numbers.
// Future improvement: externalize to JSON (feature gated with serde) to allow dynamic
// lesson packs without inflating core wasm size further.
// Tone 5 ("5") here indicates neutral tone when present.
